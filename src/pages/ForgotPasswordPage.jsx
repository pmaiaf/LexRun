  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-8">
      <div className="w-full max-w-sm">
        <button onClick={() => navigate('/login')} className="flex items-center gap-1.5 text-xs text-gray-500 hover:text-gray-700 mb-8">
        ...
        {enviado ? (
          <div className="text-center">
            ...
            <p className="text-base text-gray-500 leading-relaxed">
              Se <strong>{email}</strong> estiver cadastrado, você vai receber um link para redefinir sua senha em poucos minutos.
            </p>
          </div>
        ) : (
          <>
